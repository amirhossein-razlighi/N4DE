#!/bin/bash
#SBATCH --job-name=NIE_Playground    # Job name
...
#SBATCH --time=00:25:00         # Job timeout
#SBATCH --output=./job_out/playground_out.log      # Redirect stdout to a log file
#SBATCH --error=./job_out/playground_err.error     # Redirect stderr to a separate error log file
#SBATCH --mail-type=ALL         # Send updates via email
#SBATCH --gpus=l4-24g:1         # Request 1 GPU of model L4

srun -- mkenv -f /home/amirhossein_razlighi/codes/NIE_Animated/playground-env.yml -- \
