...
#SBATCH --output=./job_out/train1_out.log      # Redirect stdout to a log file
#SBATCH --error=./job_out/train1_err.error     # Redirect stderr to a separate error log file
...
python3 main_animated.py --config ./config/animation.yaml"
