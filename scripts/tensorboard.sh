...
#SBATCH --time=16:00:00         # Job timeout
#SBATCH --output=./job_out/tensorboard.log      # Redirect stdout to a log file
#SBATCH --error=./job_out/tensorboard.error     # Redirect stderr to a separate error log file
...
tensorboard --logidr ./logs --port 6006 --bind_all"

# python3 main_animated.py --config ./config/animation_longer.yaml
